...
public class DeleteChatRoomCommandAPIControllerTest {
    @LocalServerPort
    private int port;
    ...
    // Logger
    private static final Logger LOG = LoggerFactory.getLogger(DeleteChatRoomCommandAPIControllerTest.class);
    ...
    public void deleteChatRoomTest() throws Exception {
        ...
        sessionUser1.send("/app/message", new DeleteRoomCommand(sendMessageID, roomName));
        ...
        // Check if room have been deleted
        assert (!groupsManagementDatabaseAPI.checkIfGroupExist(roomName));
    }
}
