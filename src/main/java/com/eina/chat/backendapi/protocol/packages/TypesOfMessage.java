...
public interface TypesOfMessage{
    ...
    String AUTH_LEVEL = "GET_AUTH_LEVEL";
    String FILE_HISTORY_FROM_ROOM = "GET_FILE_HISTORY_FROM_ROOM";
    String MESSAGE_HISTORY_FROM_ROOM = "GET_MESSAGE_HISTORY_FROM_ROOM";
    String ADMINISTERED_ROOMS = "GET_ADMINISTERED_ROOMS";
    String JOINED_ROOMS = "GET_JOINED_ROOMS";
}
